...
func (l Logger) Debug(ctx context.Context, args ...interface{}) {
	l.SugaredLogger.With(extractArgsFromCtx(ctx)...).Debug(args...)
}

// Info logs a message at InfoLevel. The message includes any fields passed
// at the log site, as well as any fields extracted from the context.
func (l Logger) Info(ctx context.Context, args ...interface{}) {
	l.SugaredLogger.With(extractArgsFromCtx(ctx)...).Info(args...)
}
...
func (l Logger) Warn(ctx context.Context, args ...interface{}) {
	l.SugaredLogger.With(extractArgsFromCtx(ctx)...).Warn(args...)
}
...
func (l Logger) Error(ctx context.Context, args ...interface{}) {
	l.SugaredLogger.With(extractArgsFromCtx(ctx)...).Error(args...)
}
...
func (l Logger) DPanic(ctx context.Context, args ...interface{}) {
	l.SugaredLogger.With(extractArgsFromCtx(ctx)...).DPanic(args...)
}
...
func (l Logger) DPanicw(ctx context.Context, msg string, args ...interface{}) {
	l.SugaredLogger.DPanicw(msg, append(extractArgsFromCtx(ctx), args...)...)
}
...
func (l Logger) Panicw(ctx context.Context, msg string, args ...interface{}) {
	l.SugaredLogger.Panicw(msg, append(extractArgsFromCtx(ctx), args...)...)
}
...
func (l Logger) Fatalw(ctx context.Context, msg string, args ...interface{}) {
	l.SugaredLogger.Fatalw(msg, append(extractArgsFromCtx(ctx), args...)...)
}

type logContextKey string

const (
	logctxkey = logContextKey("args")
)
...
func extractArgsFromCtx(ctx context.Context) []interface{} {
	args, ok := ctx.Value(logctxkey).([]interface{})
	if !ok {
		return emptyArgs
	}
...
func ContextWithArgs(ctx context.Context, args ...interface{}) context.Context {
	existingArgs, ok := ctx.Value(logctxkey).([]interface{})
	if ok {
		args = append(args, existingArgs...)
	}
	return context.WithValue(ctx, logctxkey, args)
}
